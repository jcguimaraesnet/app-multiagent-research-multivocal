[Skip to content](https://github.com/raine/consult-llm#start-of-content)

You signed in with another tab or window. [Reload](https://github.com/raine/consult-llm) to refresh your session.You signed out in another tab or window. [Reload](https://github.com/raine/consult-llm) to refresh your session.You switched accounts on another tab or window. [Reload](https://github.com/raine/consult-llm) to refresh your session.Dismiss alert

{{ message }}

[raine](https://github.com/raine)/ **[consult-llm](https://github.com/raine/consult-llm)** Public

- [Notifications](https://github.com/login?return_to=%2Fraine%2Fconsult-llm) You must be signed in to change notification settings
- [Fork\\
19](https://github.com/login?return_to=%2Fraine%2Fconsult-llm)
- [Star\\
121](https://github.com/login?return_to=%2Fraine%2Fconsult-llm)


main

[**3** Branches](https://github.com/raine/consult-llm/branches) [**79** Tags](https://github.com/raine/consult-llm/tags)

[Go to Branches page](https://github.com/raine/consult-llm/branches)[Go to Tags page](https://github.com/raine/consult-llm/tags)
...
| --- | --- | --- | --- |
| ## Latest commit<br>[![raine](https://avatars.githubusercontent.com/u/11027?v=4&size=40)](https://github.com/raine)[raine](https://github.com/raine/consult-llm/commits?author=raine)<br>[update skills/implement/SKILL.md](https://github.com/raine/consult-llm/commit/250b4a551f8d82f95ea0e57291e2b30a79a5cde9)<br>last weekJun 30, 2026<br>[250b4a5](https://github.com/raine/consult-llm/commit/250b4a551f8d82f95ea0e57291e2b30a79a5cde9) · last weekJun 30, 2026<br>## History<br>[842 Commits](https://github.com/raine/consult-llm/commits/main/) <br>Open commit details<br>[View commit history for this file.](https://github.com/raine/consult-llm/commits/main/) 842 Commits |
| [.github/workflows](https://github.com/raine/consult-llm/tree/main/.github/workflows "This path skips through empty directories") | [.github/workflows](https://github.com/raine/consult-llm/tree/main/.github/workflows "This path skips through empty directories") | [release: catch already-exists error instead of pre-checking crates.io](https://github.com/raine/consult-llm/commit/f711e4044d0ec716b222be8de9c756c766a3fee7 "release: catch already-exists error instead of pre-checking crates.io  Pre-check via curl was silently failing on CI. Catching the error from cargo publish itself is simpler and more reliable.") | 3 months agoApr 26, 2026 |
| [crates](https://github.com/raine/consult-llm/tree/main/crates "crates") | [crates](https://github.com/raine/consult-llm/tree/main/crates "crates") | [opencode: use reported cost](https://github.com/raine/consult-llm/commit/f7f84c75319c39390fb2b361f1d2abb035926c28 "opencode: use reported cost  OpenCode emits a cost value on step-finish events, so the monitor should preserve and display that provider-reported value instead of falling back to static pricing only.  Carry optional cost through normalized usage events, history records, run details, and thread summaries. Static pricing remains as a fallback for API runs without reported cost.") | 3 weeks agoJun 21, 2026 |
| [examples](https://github.com/raine/consult-llm/tree/main/examples "examples") | [examples](https://github.com/raine/consult-llm/tree/main/examples "examples") | [remove mcp server and npm packaging](https://github.com/raine/consult-llm/commit/904ad66cd2e236463f613ec16a021db66dbd9a45 "remove mcp server and npm packaging  Delete the remaining MCP-only runtime and distribution pieces now that the CLI entrypoint is the shipped interface. This removes the rmcp server, schema-generation layer, npm wrapper package, and old release pipeline so the repository matches the CLI-first v3 design instead of carrying two parallel delivery paths.  The CLI now owns startup outright,  lives with the system-prompt module, and the release/install scripts only build and fetch  plus  archives. README and example docs were rewritten around direct CLI usage, while the changelog history was intentionally left untouched.  This also drops the last schemars and npm-update codepaths, updates release asset names, and keeps the repo name unchanged for now so existing GitHub URLs still work until the later rename patch.") | 3 months agoApr 24, 2026 |
| [hooks](https://github.com/raine/consult-llm/tree/main/hooks "hooks") | [hooks](https://github.com/raine/consult-llm/tree/main/hooks "hooks") | [use checkle for project checks](https://github.com/raine/consult-llm/commit/36500a254fbec25fb54a5ea8c7aec6dcdf69691c "use checkle for project checks  Add a checkle.toml catalog for the project's local check commands and route the just recipes through checkle so agents get compact, structured failure output.  Add a tracked pre-commit hook shim that delegates to checkle pre-commit, keeping staged Rust formatting and project checks on the same entry point.") | 2 weeks agoJun 27, 2026 |
| [meta](https://github.com/raine/consult-llm/tree/main/meta "meta") | [meta](https://github.com/raine/consult-llm/tree/main/meta "meta") | [readme: use new logo assets](https://github.com/raine/consult-llm/commit/ec1c24dab2de8ac6d8d2ea958a577e8b94a8b1c9 "readme: use new logo assets  Replace old logo SVGs with updated versions. Bumped display height to 120.") | 3 months agoApr 26, 2026 |
| [scripts](https://github.com/raine/consult-llm/tree/main/scripts "scripts") | [scripts](https://github.com/raine/consult-llm/tree/main/scripts "scripts") | [add hook shim installer](https://github.com/raine/consult-llm/commit/fe8886f01bb2bbfa0e0ca5ecc7329b3268540ec0 "add hook shim installer  Install tracked hook wrappers into Git's actual hook directory instead of relying on core.hooksPath. Claude-managed configuration can overwrite core.hooksPath, so the installer writes shims under the repository's Git common directory.") | 2 weeks agoJun 28, 2026 |
| [skills](https://github.com/raine/consult-llm/tree/main/skills "skills") | [skills](https://github.com/raine/consult-llm/tree/main/skills "skills") | [update skills/implement/SKILL.md](https://github.com/raine/consult-llm/commit/250b4a551f8d82f95ea0e57291e2b30a79a5cde9 "update skills/implement/SKILL.md") | last weekJun 30, 2026 |
| [src](https://github.com/raine/consult-llm/tree/main/src "src") | [src](https://github.com/raine/consult-llm/tree/main/src "src") | [claude-cli: use file refs](https://github.com/raine/consult-llm/commit/fb170c1c5f957218445395a4e186d0087cde69d4 "claude-cli: use file refs  Claude CLI understands @file prompt references, so attached files should flow through the CLI file-ref path instead of being expanded into the prompt body.  This keeps large consultations under the prompt-size limit while preserving the existing stdin, argument, resume, model, and parser behavior. The executor uses the shared CLI request preparation path and passes extra directories for fresh sessions.") | 2 weeks agoJun 27, 2026 |
| [.gitignore](https://github.com/raine/consult-llm/blob/main/.gitignore ".gitignore") | [.gitignore](https://github.com/raine/consult-llm/blob/main/.gitignore ".gitignore") | [allow api\_key in config files (local and user, not committed project)](https://github.com/raine/consult-llm/commit/2da1292eed10aaeab4ee9028db8eb76905af56e2 "allow api_key in config files (local and user, not committed project)  Users can now store provider API keys in .consult-llm.local.yaml or ~/.config/consult-llm/config.yaml instead of relying solely on environment variables.  Policy: api_key is forbidden in .consult-llm.yaml (the committed project config) and allowed in .consult-llm.local.yaml and the user config. This is enforced structurally via ApiKeyPolicy::{Allow,Forbid} passed into ConfigFile::to_env_map(), so every caller must explicitly declare whether secrets are legal — the safe path is the default.  Empty api_key values are silently skipped (consistent with how the env-var layer treats empty environment variables), so they neither enable API-backed models with an unusable key nor cause a spurious error.  ConfigFile::to_env_map() now pulls canonical env-var names from PROVIDER_SPECS (spec.api_key_env, spec.backend_env, spec.opencode_env) instead of hardcoded format strings, eliminating the existing technical debt and making future provider additions automatic.  doctor: API key status is now resolved through LayeredEnv.lookup() instead of std::env::var, so file-backed keys are recognised and shown with their source ([env], [~/.config/consult-llm/config.yaml], etc.).  config set --project: writing any provider.api_key to the committed project config now fails with a clear error before the file is written.  .gitignore: .consult-llm.local.yaml added so the secret-bearing file is gitignored by default in this repo.") | 3 months agoApr 25, 2026 |
| [.workmux.yaml](https://github.com/raine/consult-llm/blob/main/.workmux.yaml ".workmux.yaml") | [.workmux.yaml](https://github.com/raine/consult-llm/blob/main/.workmux.yaml ".workmux.yaml") | [update .workmux.yaml](https://github.com/raine/consult-llm/commit/eadae79567f3c5d5a8270b77df53ea957ed92d14 "update .workmux.yaml") | 3 months agoApr 26, 2026 |
| [CHANGELOG.md](https://github.com/raine/consult-llm/blob/main/CHANGELOG.md "CHANGELOG.md") | [CHANGELOG.md](https://github.com/raine/consult-llm/blob/main/CHANGELOG.md "CHANGELOG.md") | [claude-cli: use file refs](https://github.com/raine/consult-llm/commit/fb170c1c5f957218445395a4e186d0087cde69d4 "claude-cli: use file refs  Claude CLI understands @file prompt references, so attached files should flow through the CLI file-ref path instead of being expanded into the prompt body.  This keeps large consultations under the prompt-size limit while preserving the existing stdin, argument, resume, model, and parser behavior. The executor uses the shared CLI request preparation path and passes extra directories for fresh sessions.") | 2 weeks agoJun 27, 2026 |
| [Cargo.lock](https://github.com/raine/consult-llm/blob/main/Cargo.lock "Cargo.lock") | [Cargo.lock](https://github.com/raine/consult-llm/blob/main/Cargo.lock "Cargo.lock") | [claude-cli: use file refs](https://github.com/raine/consult-llm/commit/fb170c1c5f957218445395a4e186d0087cde69d4 "claude-cli: use file refs  Claude CLI understands @file prompt references, so attached files should flow through the CLI file-ref path instead of being expanded into the prompt body.  This keeps large consultations under the prompt-size limit while preserving the existing stdin, argument, resume, model, and parser behavior. The executor uses the shared CLI request preparation path and passes extra directories for fresh sessions.") | 2 weeks agoJun 27, 2026 |
| [Cargo.toml](https://github.com/raine/consult-llm/blob/main/Cargo.toml "Cargo.toml") | [Cargo.toml](https://github.com/raine/consult-llm/blob/main/Cargo.toml "Cargo.toml") | [claude-cli: use file refs](https://github.com/raine/consult-llm/commit/fb170c1c5f957218445395a4e186d0087cde69d4 "claude-cli: use file refs  Claude CLI understands @file prompt references, so attached files should flow through the CLI file-ref path instead of being expanded into the prompt body.  This keeps large consultations under the prompt-size limit while preserving the existing stdin, argument, resume, model, and parser behavior. The executor uses the shared CLI request preparation path and passes extra directories for fresh sessions.") | 2 weeks agoJun 27, 2026 |
| [LICENSE](https://github.com/raine/consult-llm/blob/main/LICENSE "LICENSE") | [LICENSE](https://github.com/raine/consult-llm/blob/main/LICENSE "LICENSE") | [add license](https://github.com/raine/consult-llm/commit/325182e8ee2018f4c49c37120ceb4650a2287ba6 "add license") | 6 months agoJan 28, 2026 |
| [README.md](https://github.com/raine/consult-llm/blob/main/README.md "README.md") | [README.md](https://github.com/raine/consult-llm/blob/main/README.md "README.md") | [add zai provider for glm models](https://github.com/raine/consult-llm/commit/818fbd5c8c72b88b93e2536769ff4e9c401c1358 "add zai provider for glm models  Adds a `zai` provider (model prefix `glm-`) so models like `glm-5.2` route correctly. consult-llm maps models to providers by name prefix only, so without a registered prefix `-m glm-5.2` failed with \"unable to determine provider\".  z.ai's native API is OpenAI-compatible (/api/paas/v4/chat/completions), so the provider uses the OpenAiCompat protocol with that base url and supports the `api` backend directly. it also supports the `profile` backend for the claude-cli-proxy consumption path, where a claude process points at z.ai's anthropic-messages endpoint; the requested model id is forwarded through ANTHROPIC_MODEL. the two backends are independent: api_protocol only governs the api backend, profile only forwards model_env.  Updates the builtin-catalogue golden list and the provider-block parse test to cover the new provider.") | 2 weeks agoJun 25, 2026 |
| [RELEASE.md](https://github.com/raine/consult-llm/blob/main/RELEASE.md "RELEASE.md") | [RELEASE.md](https://github.com/raine/consult-llm/blob/main/RELEASE.md "RELEASE.md") | [add crates.io publishing, homebrew tap, replace scripts/publish](https://github.com/raine/consult-llm/commit/0fea710f6b35da3e78157dba61bccc012b0c6b7d "add crates.io publishing, homebrew tap, replace scripts/publish  Publishes all three workspace crates (consult-llm-core, consult-llm, consult-llm-monitor) to crates.io on each tagged release via a new publish-crates CI job. Adds a homebrew tap (raine/homebrew-consult-llm) with an update-tap job that generates the formula from release artifacts and pushes it automatically.  Replaces scripts/publish with cargo-release from rust-release-tools (cargo-release --skip-publish), with crates.io publishing handled by CI so workspace dependency order is resolved correctly.  Review fixes applied: - version pins use =3.0.0 (exact) instead of \"3\" for internal workspace deps - publish-crates job verifies tag matches Cargo.toml version before publishing - sleep 20 replaced with polling loop (cargo search, 5s intervals, 5min timeout) - publish_if_missing() makes publishes idempotent on rerun - update-tap now needs publish-crates so tap only updates when crates land - tap commit guarded with git diff --cached --quiet to survive reruns - mkdir -p tap/Formula added before writing formula - #{bin} interpolation fixed in formula test (was \#{bin}, which escapes Ruby interpolation) - README Releasing section updated to point to RELEASE.md") | 3 months agoApr 26, 2026 |
| [build.rs](https://github.com/raine/consult-llm/blob/main/build.rs "build.rs") | [build.rs](https://github.com/raine/consult-llm/blob/main/build.rs "build.rs") | [rewrite in rust](https://github.com/raine/consult-llm/commit/4abf297b34e5e8a9cb364b35f52c5f0ca1d599d3 "rewrite in rust  Complete rewrite of the consult-llm MCP server from TypeScript to Rust using the rmcp 1.1 SDK. All functionality is preserved:  - MCP server with consult_llm tool (stdio transport) - Backend executors: API (OpenAI-compatible), Codex CLI, Gemini CLI,   Cursor CLI - Dynamic tool schema generated from model registry - Web mode (clipboard) support - Task modes (review, debug, plan, create, general) - Git diff generation, file context inclusion - External directory discovery for CLI backends - Cost calculation and logging - 30 unit tests covering config, parsers, and external dirs  Uses Rust 2024 edition with async-trait, tokio, reqwest, serde, thiserror, anyhow, and arboard. Includes justfile for development workflow (check, format, clippy, build, test).") | 4 months agoMar 6, 2026 |
| [checkle.toml](https://github.com/raine/consult-llm/blob/main/checkle.toml "checkle.toml") | [checkle.toml](https://github.com/raine/consult-llm/blob/main/checkle.toml "checkle.toml") | [use checkle for project checks](https://github.com/raine/consult-llm/commit/36500a254fbec25fb54a5ea8c7aec6dcdf69691c "use checkle for project checks  Add a checkle.toml catalog for the project's local check commands and route the just recipes through checkle so agents get compact, structured failure output.  Add a tracked pre-commit hook shim that delegates to checkle pre-commit, keeping staged Rust formatting and project checks on the same entry point.") | 2 weeks agoJun 27, 2026 |
| [justfile](https://github.com/raine/consult-llm/blob/main/justfile "justfile") | [justfile](https://github.com/raine/consult-llm/blob/main/justfile "justfile") | [add hook shim installer](https://github.com/raine/consult-llm/commit/fe8886f01bb2bbfa0e0ca5ecc7329b3268540ec0 "add hook shim installer  Install tracked hook wrappers into Git's actual hook directory instead of relying on core.hooksPath. Claude-managed configuration can overwrite core.hooksPath, so the installer writes shims under the repository's Git common directory.") | 2 weeks agoJun 28, 2026 |
| View all files |

## Repository files navigation

![consult-llm](https://github.com/raine/consult-llm/raw/main/meta/logo-light.svg)

[Quick start](https://github.com/raine/consult-llm#quick-start) ·
[Usage](https://github.com/raine/consult-llm#usage) ·
[Providers & Configuration](https://github.com/raine/consult-llm#providers--configuration) ·
[Skills](https://github.com/raine/consult-llm#skills) ·
[Logging](https://github.com/raine/consult-llm#logging) ·
[Monitor](https://github.com/raine/consult-llm#monitor) ·
[Changelog](https://github.com/raine/consult-llm/blob/main/CHANGELOG.md)
...
[Permalink: Why a second opinion?](https://github.com/raine/consult-llm#why-a-second-opinion)
...
[Permalink: How it works](https://github.com/raine/consult-llm#how-it-works)
...
For the more detailed flow, [continue below](https://github.com/raine/consult-llm#how-it-really-works).
...
This project previously used MCP as its transport layer. If you were using that version, see the [migration guide](https://github.com/raine/consult-llm#migrating-from-mcp) below.

## What you can do

[Permalink: What you can do](https://github.com/raine/consult-llm#what-you-can-do)
...
- **Use existing subscriptions** via CLI backends without API keys ( [Gemini CLI](https://github.com/raine/consult-llm#gemini-cli), [Codex CLI](https://github.com/raine/consult-llm#codex-cli), [Cursor CLI](https://github.com/raine/consult-llm#cursor-cli), [Claude CLI](https://github.com/raine/consult-llm#profile-backend), [OpenCode](https://github.com/raine/consult-llm#opencode))
- **Continue conversations across requests** with `thread_id`
- **Copy prompts to clipboard** for browser-based LLMs (`--web`)
- **[Monitor](https://github.com/raine/consult-llm#monitor) active and past runs** in a real-time TUI

[![consult-llm-monitor screenshot](https://github.com/raine/consult-llm/raw/main/meta/monitor-screenshot.webp)](https://github.com/raine/consult-llm/blob/main/meta/monitor-screenshot.webp)

## Quick Start

[Permalink: Quick Start](https://github.com/raine/consult-llm#quick-start)
...
Then invoke skills from inside your agent (see [Usage](https://github.com/raine/consult-llm#usage) right below).

## Example workflows

[Permalink: Example workflows](https://github.com/raine/consult-llm#example-workflows)
...
[Permalink: Usage](https://github.com/raine/consult-llm#usage)
...
[Permalink: CLI utilities](https://github.com/raine/consult-llm#cli-utilities)
...
[Permalink: Providers & Configuration](https://github.com/raine/consult-llm#providers--configuration)
...
[Permalink: API backend](https://github.com/raine/consult-llm#api-backend)
...
[Permalink: CLI backends](https://github.com/raine/consult-llm#cli-backends)
...
[Permalink: Gemini CLI](https://github.com/raine/consult-llm#gemini-cli)
...
[Permalink: Codex CLI](https://github.com/raine/consult-llm#codex-cli)
...
[Permalink: Cursor CLI](https://github.com/raine/consult-llm#cursor-cli)
...
[Permalink: Claude CLI](https://github.com/raine/consult-llm#claude-cli)
...
[Permalink: Profile backend](https://github.com/raine/consult-llm#profile-backend)
...
> Fields like `type: claude-cli`, `command: claude`, `interface: stream-json`, `prompt: stdin` and flags like `-p`, `--output-format stream-json`, `--verbose`, `--bare` are defaulted or auto-injected for `claude-cli` profiles. Only non-default choices need to be written. See [CLI backend profiles](https://github.com/raine/consult-llm#cli-backend-profiles) below.
...
[Permalink: OpenCode](https://github.com/raine/consult-llm#opencode)
...
[Permalink: OpenRouter](https://github.com/raine/consult-llm#openrouter)
...
[Permalink: CLI backend profiles](https://github.com/raine/consult-llm#cli-backend-profiles)
...
[Permalink: Multi-turn conversations](https://github.com/raine/consult-llm#multi-turn-conversations)
...
This works with Gemini CLI, Codex CLI, Cursor CLI, OpenCode, and Claude CLI. OpenCode sessions use a consult-llm-managed SQLite database per thread unless `OPENCODE_DB` is set in provider `env`; this avoids contention between unrelated parallel OpenCode runs while preserving resume for returned thread IDs. See the [debate skills](https://github.com/raine/consult-llm#skills) for multi-LLM workflows that use thread IDs to maintain context across debate rounds.

### Config files

[Permalink: Config files](https://github.com/raine/consult-llm#config-files)
...
[Permalink: API keys](https://github.com/raine/consult-llm#api-keys)
...
[Permalink: Known models with pricing](https://github.com/raine/consult-llm#known-models-with-pricing)
...
[Permalink: Custom system prompt](https://github.com/raine/consult-llm#custom-system-prompt)
...
| `CONSULT_LLM_DEFAULT_MODELS` | Comma-separated ordered multi-model defaults when `-m` is omitted; duplicates preserved | selectors or exact model IDs | empty (falls through to default\_model then fallback) |
...
[Permalink: Logging](https://github.com/raine/consult-llm#logging)
...
[Permalink: Monitor](https://github.com/raine/consult-llm#monitor)

`consult-llm-monitor` is a real-time TUI for active runs and history.

[![consult-llm-monitor demo](https://github.com/raine/consult-llm/raw/main/meta/monitor-demo.gif)](https://github.com/raine/consult-llm/blob/main/meta/monitor-demo.gif)[![consult-llm-monitor demo](https://github.com/raine/consult-llm/raw/main/meta/monitor-demo.gif)](https://github.com/raine/consult-llm/blob/main/meta/monitor-demo.gif)[Open consult-llm-monitor demo in new window](https://github.com/raine/consult-llm/blob/main/meta/monitor-demo.gif)
...
[Permalink: How it really works](https://github.com/raine/consult-llm#how-it-really-works)
...
Logs / monitor spoolExternal modelBackend adapter(API or local CLI)Config resolverconsult-llm CLIWorkflow skill(/consult, /debate, /collab)Host agent(Claude Code, Codex, OpenCode)UserLogs / monitor spoolExternal modelBackend adapter(API or local CLI)Config resolverconsult-llm CLIWorkflow skill(/consult, /debate, /collab)Host agent(Claude Code, Codex, OpenCode)UserAsk for a second opinionLoad matching workflow skillGather prompt and file contextPipe prompt via stdinpass files with -fResolve layered config and model selectorsBackend, model, prompt settingsDispatch normalized requestAPI request or local CLI invocationStreaming responseNormalized stream and metadataWrite prompt, response, usage, run stateStream response on stdoutSummarize and apply next steps
...
[Permalink: Skills](https://github.com/raine/consult-llm#skills)

### Architecture

[Permalink: Architecture](https://github.com/raine/consult-llm#architecture)
...
[Permalink: Invocation](https://github.com/raine/consult-llm#invocation)
...
[Permalink: Install](https://github.com/raine/consult-llm#install)
...
[Permalink: Workflow skills](https://github.com/raine/consult-llm#workflow-skills)
...
- [`consult`](https://github.com/raine/consult-llm/blob/main/skills/consult/SKILL.md): ask one or more external LLMs; any number of `--<selector>` flags, plus `--browser` for clipboard/web mode
- [`collab`](https://github.com/raine/consult-llm/blob/main/skills/collab/SKILL.md): multiple LLMs brainstorm together, building on each other's ideas
- [`collab-vs`](https://github.com/raine/consult-llm/blob/main/skills/collab-vs/SKILL.md): the agent brainstorms with one partner LLM (`--<selector>` required) in alternating turns
- [`debate`](https://github.com/raine/consult-llm/blob/main/skills/debate/SKILL.md): multiple LLMs propose and critique competing approaches
- [`debate-vs`](https://github.com/raine/consult-llm/blob/main/skills/debate-vs/SKILL.md): the agent debates one opponent LLM (`--<selector>` required), then synthesizes the best answer
- [`panel`](https://github.com/raine/consult-llm/blob/main/skills/panel/SKILL.md): role-asymmetric advisory panel; each model speaks from one expert lens, agent synthesizes a trade-off resolution. The agent picks roles to fit the task (with a `--roles` override). Modes: `--mode design` (default) or `--mode review` for diff critique
- [`review-panel`](https://github.com/raine/consult-llm/blob/main/skills/review-panel/SKILL.md): standalone multi-model code review of a diff with identical prompts; agent dedupes findings by severity/confidence. Read-only by default; `--fix` opt-in for localized must-fix items
- [`implement`](https://github.com/raine/consult-llm/blob/main/skills/implement/SKILL.md): autonomous spec → plan → review → implement → red-team workflow. Evidence-gated reviewers, written feedback ledger, triggered debug loop, opt-in commits. Rigor knob: `--rigor lite|standard|deep`
- [`phased-implement`](https://github.com/raine/consult-llm/blob/main/skills/phased-implement/SKILL.md): coordinator that breaks a large task into a DAG of phases, each running `/implement` in its own [workmux](https://github.com/raine/workmux) worktree. Supports sequential, parallel, and mixed dependencies; per-phase merge with `/merge --keep` and ancestry verification; failure halts dependents. Requires `workmux`
- [`workshop`](https://github.com/raine/consult-llm/blob/main/skills/workshop/SKILL.md): interactive design session - agent clarifies the idea with the user, fans out to multiple LLMs in parallel for divergent approach generation, user picks one, then co-design with optional multi-LLM critique. Saves a design doc; hand it to `/implement` to build

See `skills/*/SKILL.md` for the exact prompts and invocation patterns.

## Updating

[Permalink: Updating](https://github.com/raine/consult-llm#updating)
...
[Permalink: Migrating from MCP](https://github.com/raine/consult-llm#migrating-from-mcp)

If you previously used the MCP server version (`consult-llm-mcp` npm package):

1. **Install the CLI binary** (see [Quick Start](https://github.com/raine/consult-llm#quick-start)).
...
[Permalink: Development](https://github.com/raine/consult-llm#development)
...
[Permalink: Releasing](https://github.com/raine/consult-llm#releasing)

See [RELEASE.md](https://github.com/raine/consult-llm/blob/main/RELEASE.md).

## Related Projects

[Permalink: Related Projects](https://github.com/raine/consult-llm#related-projects)
...
[Readme](https://github.com/raine/consult-llm#readme-ov-file)

### License

[MIT license](https://github.com/raine/consult-llm#MIT-1-ov-file)

### Uh oh!

There was an error while loading. [Please reload this page](https://github.com/raine/consult-llm).

[Activity](https://github.com/raine/consult-llm/activity)
...
[**19**\\
forks](https://github.com/raine/consult-llm/forks)

[Report repository](https://github.com/contact/report-content?content_url=https%3A%2F%2Fgithub.com%2Fraine%2Fconsult-llm&report=raine+%28user%29)

## [Releases\  42](https://github.com/raine/consult-llm/releases)

[v3.0.22\\
Latest\\
\\
2 weeks agoJun 27, 2026](https://github.com/raine/consult-llm/releases/tag/v3.0.22)

[\+ 41 releases](https://github.com/raine/consult-llm/releases)

## [Contributors\  3](https://github.com/raine/consult-llm/graphs/contributors)

- [![@raine](https://avatars.githubusercontent.com/u/11027?s=64&v=4)](https://github.com/raine)[**raine** Raine Virta](https://github.com/raine)
- [![@onnimonni](https://avatars.githubusercontent.com/u/5691777?s=64&v=4)](https://github.com/onnimonni)[**onnimonni** Onni Hakala](https://github.com/onnimonni)
- [![@jarimustonen](https://avatars.githubusercontent.com/u/1272053?s=64&v=4)](https://github.com/jarimustonen)[**jarimustonen** Jari Mustonen](https://github.com/jarimustonen)

## Languages

- [Rust97.5%](https://github.com/raine/consult-llm/search?l=rust)
- [Shell2.3%](https://github.com/raine/consult-llm/search?l=shell)
- [Just0.2%](https://github.com/raine/consult-llm/search?l=just)
