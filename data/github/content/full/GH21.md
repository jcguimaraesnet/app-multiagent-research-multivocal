[Skip to content](https://github.com/LIANGQINGYUAN/awesome_codegeneration#start-of-content)

You signed in with another tab or window. [Reload](https://github.com/LIANGQINGYUAN/awesome_codegeneration) to refresh your session.You signed out in another tab or window. [Reload](https://github.com/LIANGQINGYUAN/awesome_codegeneration) to refresh your session.You switched accounts on another tab or window. [Reload](https://github.com/LIANGQINGYUAN/awesome_codegeneration) to refresh your session.Dismiss alert

{{ message }}

[LIANGQINGYUAN](https://github.com/LIANGQINGYUAN)/ **[awesome\_codegeneration](https://github.com/LIANGQINGYUAN/awesome_codegeneration)** Public

- [Notifications](https://github.com/login?return_to=%2FLIANGQINGYUAN%2Fawesome_codegeneration) You must be signed in to change notification settings
- [Fork\\
3](https://github.com/login?return_to=%2FLIANGQINGYUAN%2Fawesome_codegeneration)
- [Star\\
21](https://github.com/login?return_to=%2FLIANGQINGYUAN%2Fawesome_codegeneration)


main

[**1** Branch](https://github.com/LIANGQINGYUAN/awesome_codegeneration/branches) [**0** Tags](https://github.com/LIANGQINGYUAN/awesome_codegeneration/tags)

[Go to Branches page](https://github.com/LIANGQINGYUAN/awesome_codegeneration/branches)[Go to Tags page](https://github.com/LIANGQINGYUAN/awesome_codegeneration/tags)
...
| --- | --- | --- | --- |
| ## Latest commit<br>[![LIANGQINGYUAN](https://avatars.githubusercontent.com/u/19152897?v=4&size=40)](https://github.com/LIANGQINGYUAN)[LIANGQINGYUAN](https://github.com/LIANGQINGYUAN/awesome_codegeneration/commits?author=LIANGQINGYUAN)<br>[update the table of content](https://github.com/LIANGQINGYUAN/awesome_codegeneration/commit/626c1b777fd620b3e8a8b6fb0adb1678f8710ce5)<br>4 years agoNov 2, 2022<br>[626c1b7](https://github.com/LIANGQINGYUAN/awesome_codegeneration/commit/626c1b777fd620b3e8a8b6fb0adb1678f8710ce5) · 4 years agoNov 2, 2022<br>## History<br>[26 Commits](https://github.com/LIANGQINGYUAN/awesome_codegeneration/commits/main/) <br>Open commit details<br>[View commit history for this file.](https://github.com/LIANGQINGYUAN/awesome_codegeneration/commits/main/) 26 Commits |
| [imgs](https://github.com/LIANGQINGYUAN/awesome_codegeneration/tree/main/imgs "imgs") | [imgs](https://github.com/LIANGQINGYUAN/awesome_codegeneration/tree/main/imgs "imgs") | [update CoditT5](https://github.com/LIANGQINGYUAN/awesome_codegeneration/commit/236b60cc2c84c4fdde9da7d2f6a18268fa296e1d "update CoditT5") | 4 years agoSep 8, 2022 |
| [README.md](https://github.com/LIANGQINGYUAN/awesome_codegeneration/blob/main/README.md "README.md") | [README.md](https://github.com/LIANGQINGYUAN/awesome_codegeneration/blob/main/README.md "README.md") | [update the table of content](https://github.com/LIANGQINGYUAN/awesome_codegeneration/commit/626c1b777fd620b3e8a8b6fb0adb1678f8710ce5 "update the table of content") | 4 years agoNov 2, 2022 |
| View all files |

## Repository files navigation

- [Code Generation](https://github.com/LIANGQINGYUAN/awesome_codegeneration#code-generation)
  - [Datasets](https://github.com/LIANGQINGYUAN/awesome_codegeneration#datasets)
    - [Dataset for imperative programming language generation](https://github.com/LIANGQINGYUAN/awesome_codegeneration#dataset-for-imperative-programming-language-generation)
    - [Dataset for Text-to-SQL generation](https://github.com/LIANGQINGYUAN/awesome_codegeneration#dataset-for-text-to-sql-generation)
  - [Techniques](https://github.com/LIANGQINGYUAN/awesome_codegeneration#techniques)
    - [Generation architectures](https://github.com/LIANGQINGYUAN/awesome_codegeneration#generation-architectures)
    - [Pretrained models](https://github.com/LIANGQINGYUAN/awesome_codegeneration#pretrained-models)
  - [Tools](https://github.com/LIANGQINGYUAN/awesome_codegeneration#tools)
- [Code Understanding](https://github.com/LIANGQINGYUAN/awesome_codegeneration#code-understanding)
  - [Datasets](https://github.com/LIANGQINGYUAN/awesome_codegeneration#datasets-1)
  - [Techniques](https://github.com/LIANGQINGYUAN/awesome_codegeneration#techniques-1)
    - [Variable representation](https://github.com/LIANGQINGYUAN/awesome_codegeneration#variable-representation)
    - [Code representation](https://github.com/LIANGQINGYUAN/awesome_codegeneration#code-representation)
    - [Code and comment](https://github.com/LIANGQINGYUAN/awesome_codegeneration#code-and-comment)
    - [Understanding with GNNs](https://github.com/LIANGQINGYUAN/awesome_codegeneration#understanding-with-gnns)
    - [Understanding with pre-trained models](https://github.com/LIANGQINGYUAN/awesome_codegeneration#understanding-with-pre-trained-models)
- [End](https://github.com/LIANGQINGYUAN/awesome_codegeneration#end)

# Code Generation

[Permalink: Code Generation](https://github.com/LIANGQINGYUAN/awesome_codegeneration#code-generation)

A list of papers and resources dedicated to code generation

## Datasets

[Permalink: Datasets](https://github.com/LIANGQINGYUAN/awesome_codegeneration#datasets)

### Dataset for imperative programming language generation

[Permalink: Dataset for imperative programming language generation](https://github.com/LIANGQINGYUAN/awesome_codegeneration#dataset-for-imperative-programming-language-generation)
...
[Permalink: Dataset for Text-to-SQL generation](https://github.com/LIANGQINGYUAN/awesome_codegeneration#dataset-for-text-to-sql-generation)
...
[Permalink: Techniques](https://github.com/LIANGQINGYUAN/awesome_codegeneration#techniques)

### Generation architectures

[Permalink: Generation architectures](https://github.com/LIANGQINGYUAN/awesome_codegeneration#generation-architectures)
...
[Permalink: Pretrained models](https://github.com/LIANGQINGYUAN/awesome_codegeneration#pretrained-models)
...
[![](https://github.com/LIANGQINGYUAN/awesome_codegeneration/raw/main/imgs/CodeXGLUE.png)](https://github.com/LIANGQINGYUAN/awesome_codegeneration/blob/main/imgs/CodeXGLUE.png)
...
[![](https://github.com/LIANGQINGYUAN/awesome_codegeneration/raw/main/imgs/CoditT5.png)](https://github.com/LIANGQINGYUAN/awesome_codegeneration/blob/main/imgs/CoditT5.png)
...
[Permalink: Tools](https://github.com/LIANGQINGYUAN/awesome_codegeneration#tools)
...
[Permalink: Code Understanding](https://github.com/LIANGQINGYUAN/awesome_codegeneration#code-understanding)

## Datasets

[Permalink: Datasets](https://github.com/LIANGQINGYUAN/awesome_codegeneration#datasets-1)
...
[Permalink: Techniques](https://github.com/LIANGQINGYUAN/awesome_codegeneration#techniques-1)

### Variable representation

[Permalink: Variable representation](https://github.com/LIANGQINGYUAN/awesome_codegeneration#variable-representation)
...
[Permalink: Code representation](https://github.com/LIANGQINGYUAN/awesome_codegeneration#code-representation)
...
[Permalink: Code and comment](https://github.com/LIANGQINGYUAN/awesome_codegeneration#code-and-comment)
...
[Permalink: Understanding with GNNs](https://github.com/LIANGQINGYUAN/awesome_codegeneration#understanding-with-gnns)
...
[Permalink: Understanding with pre-trained models](https://github.com/LIANGQINGYUAN/awesome_codegeneration#understanding-with-pre-trained-models)
...
[![](https://github.com/LIANGQINGYUAN/awesome_codegeneration/raw/main/imgs/Compressor_img01.png)](https://github.com/LIANGQINGYUAN/awesome_codegeneration/blob/main/imgs/Compressor_img01.png)

# End

[Permalink: End](https://github.com/LIANGQINGYUAN/awesome_codegeneration#end)
...
[Readme](https://github.com/LIANGQINGYUAN/awesome_codegeneration#readme-ov-file)

### Uh oh!

There was an error while loading. [Please reload this page](https://github.com/LIANGQINGYUAN/awesome_codegeneration).

[Activity](https://github.com/LIANGQINGYUAN/awesome_codegeneration/activity)
...
[**3**\\
forks](https://github.com/LIANGQINGYUAN/awesome_codegeneration/forks)

[Report repository](https://github.com/contact/report-content?content_url=https%3A%2F%2Fgithub.com%2FLIANGQINGYUAN%2Fawesome_codegeneration&report=LIANGQINGYUAN+%28user%29)

## [Releases](https://github.com/LIANGQINGYUAN/awesome_codegeneration/releases)

No releases published

## [Packages\  0](https://github.com/users/LIANGQINGYUAN/packages?repo_name=awesome_codegeneration)

No packages published

## [Contributors\  1](https://github.com/LIANGQINGYUAN/awesome_codegeneration/graphs/contributors)

- [![@LIANGQINGYUAN](https://avatars.githubusercontent.com/u/19152897?s=64&v=4)](https://github.com/LIANGQINGYUAN)[**LIANGQINGYUAN** LiangQingYuan](https://github.com/LIANGQINGYUAN)
